    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        sendVerificationCode.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(Phone_Login_Activity.this, "Please enter phone number", Toast.LENGTH_SHORT).show();
                }
                else
                {
        ...
        VerifyButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(Phone_Login_Activity.this, "Please enter the code", Toast.LENGTH_SHORT).show();
                }
                else
                {
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks()
        {
            ...
            {
                Toast.makeText(Phone_Login_Activity.this, "Invalid Phone Number", Toast.LENGTH_SHORT).show();
                LoadingBar.dismiss();
            ...
            public void onCodeSent(@NonNull String verificationId,
                ...
                Toast.makeText(Phone_Login_Activity.this, "Verification Code sent successfully", Toast.LENGTH_SHORT).show();
